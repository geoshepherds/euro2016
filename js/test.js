else if ( sliderDate === matchDate.date && matchDate.city === "Saint-Denis"){
            g.selectAll("circle#Saint-Denis")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Lille"){
            g.selectAll("circle#Lille")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Lens"){
            g.selectAll("circle#Lens")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Lyon"){
            g.selectAll("circle#Lyon")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Saint-Etienne"){
            g.selectAll("circle#Saint-Etienne")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Bordeaux"){
            g.selectAll("circle#Bordeaux")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Toulouse"){
            g.selectAll("circle#Toulouse")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Marseille"){
            g.selectAll("circle#Marseille")
                .attr("r", 25);
        } else if ( sliderDate === matchDate.date && matchDate.city === "Nice"){
            g.selectAll("circle#Nice")
                .attr("r", 25);
        }
